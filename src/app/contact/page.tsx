...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Suhail Ahmed — Azure DevOps Engineer & Agentic AI Builder based in Sydney.",
};
        ...
        <FadeInSection>
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-xl mx-auto leading-relaxed">
              Open to Azure DevOps, DevSecOps, and Agentic AI roles. Based in Sydney,
              available globally.
            </p>
          </div>
        </FadeInSection>
        ...
        <FadeInSection>
          <div className="rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 p-8 md:p-10 text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-6 max-w-lg mx-auto">
              Whether it&rsquo;s building autonomous AI pipelines on Azure or modernizing
              your DevSecOps workflows, I&rsquo;d love to hear about it.
            </p>
            <a
              href="mailto:suhail39ahmed@gmail.com?subject=Project%20Inquiry&body=Hi%20Suhail%2C%0A%0AI'd%20like%20to%20discuss%20a%20project%20with%20you.%0A%0A"
